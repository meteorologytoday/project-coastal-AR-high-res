...
output_file = "salt_budget_closure.nc"
...
data = dlh.loadDataByDate(test_dt, msm, **crop_kwargs, datasets=["diag_Sbdgt", "diag_2D", "diag_state",])

print("Compute heat budget")
ds = cb.computeSaltTendency(data, coo, return_xarray = True)
